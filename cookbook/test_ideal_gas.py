...
from ljhouses import simulate, StochasticBerendsenThermostat, NVEThermostat
...
samples, t, K, V, Vij = simulate(dt, 1_000, 1, 10, LJ_r, LJ_e, LJ_Rmax, g, x, v, a, thermostat)
print(samples[-1][0][:2])
print(samples[-2][0][:2])
