...
exec(open("./ljhouses/metadata.py").read())
...
setup(
    ...
    url = 'https://github.com/benmaier/ljhouses',
    license = __license__,
    ...
    project_urls={
        'Documentation': 'https://github.com/benmaier/ljhouses',
        'Contributing Statement': 'https://github.com/benmaier/ljhouses/blob/master/CONTRIBUTING.md',
        'Bug Reports': 'https://github.com/benmaier/ljhouses/issues',
        'Source': 'https://github.com/benmaier/ljhouses/',
        'PyPI': 'https://pypi.org/project/ljhouses/',
    },
